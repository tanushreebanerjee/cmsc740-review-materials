...
This review material is organized into five major sections covering all course topics. Each section contains:
- Key concepts and definitions
- Important equations and formulas
- Practice problems with solutions
- Visual diagrams and sketches (descriptions)
- Common exam question types

---

## Part 1: Rendering Fundamentals
📄 [Part 1: Introduction, Acceleration Structures, Radiometry, Monte Carlo Integration](review_part1_fundamentals.md)
...
📄 [Part 2: BRDF, Rendering Equation, Advanced Sampling, BDPT, Participating Media](review_part2_advanced_rendering.md)
...
📄 [Part 3: Denoising, Neural Radiosity, Neural Importance Sampling](review_part3_neural_rendering.md)
...
📄 [Part 4: Geometry Processing, Point Clouds, Scene Reconstruction, NeRF](review_part4_geometry_reconstruction.md)
...
📄 [Part 5: Deep Learning Architectures, Generative Modeling, Shape Synthesis](review_part5_shape_modeling.md)
...
📄 [Equation Reference Sheet](review_equations_reference.md)

A quick reference guide to all important equations organized by topic.
...
3. **Understand the connections** - Many topics build on each other (e.g., Monte Carlo → Rendering Equation → BDPT)
